  ...
  await message.edit({
    embeds: new EmbedBuilder()
      .setAuthor({
        ...
        iconURL: message.guild?.iconURL() ?? main.client.user.avatarURL(),
      })
      .setThumbnail(message.guild?.iconURL() ?? main.client.user.avatarURL())
      .addFields([
        {
          ...
          value: main.client.locales.__mf(
            ...
            {
              channel:
                message.guild?.channels.get(data?.channel_id ?? "")?.mention ??
        ...
        },
        {
          ...
          value: main.client.locales.__mf(
            ...
            {
              reviewChannel:
                message.guild?.channels.get(data?.revision_channel_id ?? "")
      ...
      new ActionRowBuilder()
        .addComponents([
          ...
          new ButtonBuilder()
            ...
            .setEmoji({
              name: "_",
              id: data?.threads ? "1203774493936455730" : "1203774491763937300",
            })
